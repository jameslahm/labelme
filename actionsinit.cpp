...
void ActionsInit::setUp(MainWindow* w){

    QStyle* style=QApplication::style();
    QAction* a1=new QAction(w);//打开文件
    a1->setText("Open");
    a1->setStatusTip("Open");
    a1->setShortcut(QKeySequence::Open);
//    a1->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_Plus+Qt::Key_Plus));
    ...
    QAction* a2=new QAction(w);//下一张图片
    a2->setText("Next\nImage");
    a2->setEnabled(false);
    ...
    QAction* a3=new QAction(w);//上一张图片
    a3->setText("Prev\nImage");
    a3->setEnabled(false);
    ...
    QAction* a5=new QAction(w);//打开最近
    a5->setText("Open Recent");
    a5->setStatusTip("Open Recent");
//        a5->setShortcut(QKeySequence(Qt::Key_D));
//        a5->setIcon(style->standardIcon(QStyle::SP_ArrowRight));
    connect(a5,&QAction::triggered,w,&MainWindow::openrecent);
    map->insert("Open Recent",a5);

    QAction* a6=new QAction(w);//保存文件
    a6->setText("Save");
    a6->setEnabled(false);
...
//        a8->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_S));
    ...
    QAction* a9=new QAction(w);//改变输出目录
    a9->setText("Change Output Dir");
    a9->setStatusTip("Change Output Dir");
//        a8->setShortcut(QKeySequence(Qt::CTRL+Qt::SHIFT+Qt::Key_S));
    ...
    QAction* a10=new QAction(w);//关闭文件
    a10->setText("Close");
    ...
    QAction* a11=new QAction(w);//删除文件
    a11->setText("Delete\nFile");
    ...
    QAction* a12=new QAction(w);//退出程序
    a12->setText("Quit");
    ...
    QAction* a13=new QAction(w);//创建笔刷
    a13->setText("Create\nBrush");
    ...
    QAction* a38=new QAction(w);//创建多边形
    a38->setText("Create\nPolygons");
    ...
    QAction* a14=new QAction(w);//创建矩形
    a14->setText("Create\nRectangle");
    ...
    QAction* a15=new QAction(w);//创建圆形
...
//        a18->setShortcut(QKeySequence(Qt::CTRL+Qt::SHIFT+Qt::Key_S));
    ...
    QAction* a20=new QAction(w);//编辑label
    a20->setText("Edit\nLabel");
    ...
    QAction* a21=new QAction(w);//复制多边形
    ...
    connect(a21,&QAction::triggered,w,&MainWindow::duplicatepolygons);
    map->insert("Duplicate Polygons",a21);

    QAction* a22=new QAction(w);//删除多边形
    a22->setText("Delete\nPolygons");
    ...
    QAction* a23=new QAction(w);//撤销操作
    a23->setText("Undo");
    ...
    QAction* a24=new QAction(w);//撤销当前操作
    a24->setText("Undo last point");
    a24->setEnabled(false);
    a24->setStatusTip("Undo last point");
//    a24->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_L+Qt::Key_P));
    ...
    QAction* a25=new QAction(w);//编辑笔刷
    a25->setText("Edit\nBrush");
    ...
    QAction* a26=new QAction(w);//改变绘制多边形颜色
...
//        a19->setIcon(QIcon(QPixmap(":/icons/icons/edit.png")));
    connect(a26,&QAction::triggered,w,&MainWindow::polygonlinecolor);
    map->insert("Polygon Line Color",a26);

    QAction* a27=new QAction(w);//改变多边形填充颜色
    ...
    connect(a27,&QAction::triggered,w,&MainWindow::polygonfillcolor);
    map->insert("Polygon Fill Color",a27);

//        QAction* a28=new QAction(w);//设置flags
//        a28->setText("Flags");
//        a28->setCheckable(true);
//        a28->setChecked(true);
//        a28->setStatusTip("Flags");
//        a28->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_J));
//        a28->setIcon(QIcon(QPixmap(":/icons/icons/edit.png")));
//        connect(a28,&QAction::triggered,w,&MainWindow::flags);
//        map->insert("Flags",a28);

//        QAction* a29=new QAction(w);//设置labellist
//        a29->setText("Label List");
//        a29->setCheckable(true);
//        a29->setChecked(true);
//        a29->setStatusTip("Label List");
//        a29->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_J));
//        a29->setIcon(QIcon(QPixmap(":/icons/icons/edit.png")));
//        connect(a29,&QAction::triggered,w,&MainWindow::labellist);
//        map->insert("Label List",a29);

    QAction* a30=new QAction(w);//显示多边形的labels
    a30->setText("Polygon Labels");
    a30->setCheckable(true);
    a30->setChecked(true);
    a30->setStatusTip("Polygon Labels");
//        a30->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_J));
//        a30->setIcon(QIcon(QPixmap(":/icons/icons/edit.png")));
    connect(a30,&QAction::triggered,w,&MainWindow::polygonlabels);
    map->insert("Polygon Labels",a30);

    QAction* a31=new QAction(w);//显示文件列表
    a31->setText("File List");
    a31->setCheckable(true);
    a31->setChecked(true);
    a31->setStatusTip("File List");
//        a31->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_J));
//        a31->setIcon(QIcon(QPixmap(":/icons/icons/edit.png")));
    connect(a31,&QAction::triggered,w,&MainWindow::filelist);
    map->insert("File List",a31);

    QAction* a32=new QAction(w);//隐藏多边形
    a32->setText("Hide Polygons");
    a32->setStatusTip("Hide Polygons");
//        a32->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_B));
    ...
    QAction* a33=new QAction(w);//显示多边形
    a33->setText("Show Polygons");
    a33->setStatusTip("Show Polygons");
//        a33->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_B));
    ...
    QAction* a34=new QAction(w);//放大页面
    a34->setText("Zoom\nIn");
    ...
    QAction* a35=new QAction(w);//缩小页面
    a35->setText("Zoom\nOut");
    ...
    QAction* a36=new QAction(w);//显示原始大小
    ...
    QAction* a37=new QAction(w);//恢复正常显示界面
    a37->setText("Fit\nWindow");
    ...
    QAction* a39=new QAction(w);//恢复正常显示界面
    a39->setText("Edit Color");
    a39->setEnabled(false);
    a39->setStatusTip("Edit Color");
//    a39->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_F));
...
//    a41->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_F));
    ...
    QAction* a42=new QAction(w);//导入标注文件
    a42->setText("Import");
    a42->setEnabled(false);
    a42->setStatusTip("Import");
//    a42->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_F));
//    a42->setIcon(QIcon(QPixmap(":/icons/icons/zoom-in.png")));
    connect(a42,&QAction::triggered,w,&MainWindow::import);
    map->insert("Import",a42);

    QAction* a43=new QAction(w);//删除标签
...
//    a42->setIcon(QIcon(QPixmap(":/icons/icons/zoom-in.png")));
    ...
    QAction* a44=new QAction(w);//创建平滑曲线
    ...
    QAction* a45=new QAction(w);//切换3D模式
    a45->setText("3D");
    a45->setEnabled(true);
    ...
    a45->setStatusTip("3D");
//    a42->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_F));
//    a45->setIcon(QIcon(QPixmap(":/icons/icons/objects.png")));
...
//    menu2->addAction(map->value("Duplicate Polygons"));
...
//    menu2->addAction(map->value("Polygon Line Color"));
//    menu2->addAction(map->value("Polygon Fill Color"));
...
//    tbar->addAction(map->value("Delete File"));
...
//    tbar->addAction(map->value("Undo last point"));
